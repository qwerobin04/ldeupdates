...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="css-landing/landing-page.css" />
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-3 col-md-3 col-sm-6">
          <figure class="step os-animation" data-os-animation="fadeInLeft" data-os-animation-delay="0.50s"> <img src="images-landing/one.png" alt="" /> </figure>
          <div class="arrow"> <img src="images-landing/arrow.png" alt="" /> </div>
        </div>
        <div class="col-lg-3 col-md-3 col-sm-6">
          <figure class="step os-animation" data-os-animation="fadeInLeft" data-os-animation-delay="1.5s"> <img src="images-landing/two.png" alt="" /> </figure>
          <div class="arrow1 "> <img src="images-landing/arrow.png" alt="" /> </div>
        </div>
        <div class="col-lg-3 col-md-3 col-sm-6">
          <figure class="step os-animation" data-os-animation="fadeInLeft" data-os-animation-delay="2.5s"> <img src="images-landing/thrww.png" alt="" /> </figure>
          <div class="arrow"> <img src="images-landing/arrow.png" alt="" /> </div>
        </div>
        <div class="col-lg-3 col-md-3 col-sm-6">
          <figure class="step1 os-animation" data-os-animation="fadeInLeft" data-os-animation-delay="3.5s"> <img src="images-landing/four.png" alt="" /> </figure>
        </div>
      </div>
    </div>
  </section>
...
" data-os-animation-delay="0.20s">
          <div class="img clearfix"> <img src="images-landing/002.png" alt="" /> </div>
...
" data-os-animation-delay="0.50s">
          <div class="img"> <img src="images-landing/003.png" alt="" /> </div>
          <div class="title">
            <h3>Olister Combo<br />
              pack lorem</h3>
            <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. </p>
...
" data-os-animation-delay="1s">
          <div class="img"> <img src="images-landing/oo1.png" alt="" /> </div>
          <div class="title">
            <h3>Olister Combo<br />
              pack lorem</h3>
            <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. </p>
      ...
      <div class="col-lg-4 col-md-4 col-sm-4">
        ...
        <div class="row">
          <div class="col-lg-6 col-md-8 col-sm-8 col-xs-6">
            <figure class="rest os-animation" data-os-animation="fadeInDown" data-os-animation-delay="1s"> <a href="#"><img src="images-landing/pizzhut.png" alt="" /> </a> </figure>
          </div>
          <div class="col-lg-6 col-md-8 col-sm-8 col-xs-6">
            <figure class="rest os-animation" data-os-animation="fadeInDown" data-os-animation-delay="1.2s"> <a href="#"> <img src="images-landing/SUB.png" alt="" /></a></figure>
          </div>
        </div>
        <!--row-->
        ...
        <div class="row">
          <div class="col-lg-6 col-md-8 col-sm-8 col-xs-6">
            <figure class="rest os-animation" data-os-animation="fadeInDown" data-os-animation-delay="1.4s"> <a href="#"> <img src="images-landing/KFC.png" alt="" /></a> </figure>
          </div>
          <div class="col-lg-6 col-md-8 col-sm-8 col-xs-6">
            <figure class="rest os-animation" data-os-animation="fadeInDown" data-os-animation-delay="1.6s"> <a href="#"><img src="images-landing/papjohns.png" alt="" /></a> </figure>
          </div>
        </div>
        <!--row-->
        ...
        <div class="row">
          <div class="col-lg-6 col-md-8 col-sm-8 col-xs-6">
            <figure class="rest os-animation" data-os-animation="fadeInDown" data-os-animation-delay="1.8s"> <a href="#"><img src="images-landing/dominos.png" alt="" /></a> </figure>
          </div>
          <div class="col-lg-6 col-md-8 col-sm-8 col-xs-6">
            <figure class="rest os-animation" data-os-animation="fadeInDown" data-os-animation-delay="2s"> <a href="#"><img src="images-landing/barista.png" alt="" /></a> </figure>
          </div>
        </div>
        <!--row-->
...
" data-os-animation-delay="3s"> <img src="images-landing/pizz.png" alt="" />
                <div class="order"> <a href="#">Food Name</a> </div>
              </figure>
            </div>
            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6">
              <figure class="food os-animation" data-os-animation="fadeInDown
" data-os-animation-delay="3.2s"> <img src="images-landing/burgar.png" alt="" />
                <div class="order"> <a href="#">Food Name</a> </div>
              </figure>
            </div>
            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6">
              <figure class="food os-animation" data-os-animation="fadeInDown
" data-os-animation-delay="3.4s"> <img src="images-landing/donelt.png" alt="" />
                <div class="order"> <a href="#">Food Name</a> </div>
              </figure>
            </div>
            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6">
              <figure class="food os-animation" data-os-animation="fadeInDown
" data-os-animation-delay="3.6s"> <img src="images-landing/sup.png" alt="" />
                <div class="order"> <a href="#">Food Name</a> </div>
              </figure>
            </div>
          </div>
        ...
        <div class="food1">
          <div class="row">
            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6">
              <figure class="food os-animation" data-os-animation="fadeInDown
" data-os-animation-delay="3.8s"> <img src="images-landing/checken.png" alt="" />
                <div class="order"> <a href="#">Food Name</a> </div>
              </figure>
            </div>
            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6">
              <figure class="food os-animation" data-os-animation="fadeInDown
" data-os-animation-delay="4s"> <img src="images-landing/passta.png" alt="" />
                <div class="order"> <a href="#">Food Name</a> </div>
              </figure>
            </div>
            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6">
              <figure class="food os-animation" data-os-animation="fadeInDown
" data-os-animation-delay="4.2s"> <img src="images-landing/bhel.png" alt="" />
                <div class="order"> <a href="#">Food Name</a> </div>
              </figure>
            </div>
            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6">
              <figure class="food os-animation" data-os-animation="fadeInDown
" data-os-animation-delay="4.4s"> <img src="images-landing/past.png" alt="" />
                <div class="order"> <a href="#">Food Name</a> </div>
              </figure>
            </div>
          </div>
    ...
    <div class="container">
      <div class="row bg os-animation" data-os-animation="flash" data-os-animation-delay="1s">
        ...
        <div class="col-lg-5 col-md-5 col-sm-5">
          <figure class="imgs"> <img src="images-landing/abc.png" alt="" /> </figure>
        </div>
        <div class="col-lg-2 col-md-2 col-sm-2">
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-4 col-md-4 col-sm-4  col-xs-12">
          <figure class="service os-animation" data-os-animation="fadeInDown" data-os-animation-delay="1s"> <img src="images-landing/plan.png" alt="" /> </figure>
        ...
        <div class="col-lg-4 col-md-4 col-sm-4  col-xs-12">
          <figure class="service os-animation" data-os-animation="fadeInDown" data-os-animation-delay="1.5s"> <img src="images-landing/mak.png" alt="" /> </figure>
        ...
        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
          <figure class="service os-animation" data-os-animation="fadeInDown" data-os-animation-delay="2s"> <img src="images-landing/kljj.png" alt="" /> </figure>
  ...
  <!-- <footer class="section9">
    <div class="container">
      <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12">
          <div class="email">&copy; All right reserved 2018 / Lokal Delivery Express </div>
        </div>
      </div>
    </div>
  </footer> -->
