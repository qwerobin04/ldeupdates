  ...
  <div class="left-sidebar-pro">
    <nav id="sidebar" class="">
      <div class="sidebar-header">
        <a href="./indexPartner.php"><img class="main-logo" src="" alt="" /></a>
      ...
      <div class="left-custom-menu-adp-wrap comment-scrollbar">
        <nav class="sidebar-nav left-sidebar-menu-pro">
          <ul class="metismenu" id="menu1">
            <li class="active">
              <a class="has-arrow" href="./indexPartner.php">
                <i class="fa big-icon fa-home icon-wrap"></i>
                <span class="mini-click-non">Main</span>
              </a>
              <ul class="submenu-angle" aria-expanded="true">
                <li><a title="Dashboard v.1" href="./indexPartner.php"><i class="fa fa-bullseye sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Dashboard</span></a></li>
                <li><a title="Orders" href="./ordersPartner.php"><i class="fa fa-line-chart sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Orders</span></a></li>
                <!-- <li><a title="Menu List" href="menu.php"><i class="fa fa-diamond sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Categories</span></a></li> -->
                <li><a title="Food List" href="./foodPartner.php"><i class="fa fa-heart sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Food</span></a></li>
              </ul>
            </li>
                      ...
                      <ul class="nav navbar-nav mai-top-nav header-right-menu">
                              ...
                              <li>
                                <a href="#">
                                  ...
                                  <div class="message-content">
                                    <span class="message-date">Date Here</span>
                                    <h2>Admin</h2>
                              ...
                              <li>
                                <a href="#">
                                  ...
                                  <div class="notification-content">
                                    <span class="notification-date">Date Here</span>
                                    <h2>Test</h2>
                                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. </p>
                                  </div>
                                </a>
                        ...
                        <li class="nav-item">
                          <a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle">
                            ...
                            <span class="admin-name">Admin Partner</span>
                  ...
                  <ul class="mobile-menu-nav">
                    <li><a data-toggle="collapse" data-target="#Charts" href="#">Home <span class="admin-project-icon adminpro-icon adminpro-down-arrow"></span></a>
                      <ul class="collapse dropdown-header-top">
                        ...
                        <li><a href="./ordersPartner.php">Orders</a></li>
                      </ul>
                    </li>
                  </ul>
                </nav>
          ...
          <div class="row">
              ...
              <div class="admin-content analysis-progrebar-ctn res-mg-t-15">
                ...
                <div class="row vertical-center-box vertical-center-box-tablet">
                  <div class="col-xs-3 mar-bot-15 text-left">
                    <label class="label bg-green">69% <i class="fa fa-level-up" aria-hidden="true"></i></label>
                  </div>
                  <div class="col-xs-9 cus-gh-hd-pro">
                    <h2 class="text-right no-margin">69</h2>
                  </div>
                </div>
              ...
              <div class="admin-content analysis-progrebar-ctn res-mg-t-30">
                ...
                <div class="row vertical-center-box vertical-center-box-tablet">
                  <div class="text-left col-xs-3 mar-bot-15">
                    <label class="label bg-red">69% <i class="fa fa-level-down" aria-hidden="true"></i></label>
                  </div>
                  <div class="col-xs-9 cus-gh-hd-pro">
                    <h2 class="text-right no-margin">69</h2>
                  </div>
            ...
            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
              <div class="admin-content analysis-progrebar-ctn res-mg-t-30">
                ...
                <div class="row vertical-center-box vertical-center-box-tablet">
                  <div class="text-left col-xs-3 mar-bot-15">
                    <label class="label bg-blue">69% <i class="fa fa-level-up" aria-hidden="true"></i></label>
                  </div>
                  <div class="col-xs-9 cus-gh-hd-pro">
                    <h2 class="text-right no-margin">Php69</h2>
                  </div>
                </div>
                <div class="progress progress-mini">
            ...
            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
              <div class="admin-content analysis-progrebar-ctn res-mg-t-30">
                ...
                <div class="row vertical-center-box vertical-center-box-tablet">
                  <div class="text-left col-xs-3 mar-bot-15">
                    <label class="label bg-purple">69% <i class="fa fa-level-up" aria-hidden="true"></i></label>
                  </div>
                  <div class="col-xs-9 cus-gh-hd-pro">
                    <h2 class="text-right no-margin">Php69</h2>
                  </div>
          ...
          <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
            ...
            <div class="white-box analytics-info-cs">
              ...
              <ul class="list-inline two-part-sp">
                ...
                <li class="text-right"><i class="fa fa-level-down" aria-hidden="true"></i> <span class="text-danger">69%</span></li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
            <div class="white-box tranffic-als-inner">
              <h3 class="box-title"><small class="pull-right m-t-10 text-success"><i class="fa fa-sort-asc"></i> 69% last month</small> Site Traffic</h3>
              <div class="stats-row">
                <div class="stat-item">
          ...
          <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
            <div class="white-box tranffic-als-inner res-mg-t-30">
              <h3 class="box-title"><small class="pull-right m-t-10 text-danger"><i class="fa fa-sort-desc"></i> 69% last month</small>Site Traffic</h3>
              <div class="stats-row">
                <div class="stat-item">
                  <h6>Overall Growth</h6>
                  <b>69%</b>
