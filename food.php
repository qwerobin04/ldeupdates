                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          ...
                          <!-- content goes here -->
                          <form action = "./php/insertfood.php" method="post">
                            <div class="form-group">
                              <label for="exampleAddRestaurant1">Restaurant: </label>
                              <select class="field small-field" name = "restaurant">
                                <option value="" required>Choose Restaurant</option>
                            ...
                            <div class="form-group">
                              <label for="exampleAddLocation1">Food</label>
                              <input type="location" name = "foodname" class="form-control" id="exampleAddLocation1" placeholder="Enter new food" required>
                            </div>
                            <!-- <div class="form-group">
                        ...
                        <div class="modal-footer">
                          <div class="btn-group btn-group-justified" role="group" aria-label="group button">
                            ...
                            <div class="btn-group" role="group">
                              <button  id="saveImage" class="btn btn-default btn-hover-green" name = " insert">Save</button>
                            </div>
                            </form>
                          </div>
                        </div>
                  ...
                  <div class="modal fade" id="edit-business" tabindex="-1" role="dialog" aria-labelledby="modalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                      <div class="modal-content">
                        <div class="modal-header">
                          <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true"></span><span class="sr-only">Close</span></button>
                          <h3 class="modal-title" id="lineModalLabel">Edit Food</h3>
                        </div>
                        <div class="modal-body">
                          ...
                          <form action = "./php/insertfood.php" method="post">
                            ...
                            <div class="form-group">
                              <label for="exampleEditLocation1">Food</label>
                              <input type="location" name = "foodname" class="form-control" id="exampleEditLocation1" placeholder="Enter new food">
                            </div>
                            <!-- <div class="form-group">
                            <label for="exampleInputFile">File input</label>
                            <input type="file" id="exampleInputFile">
                        ...
                        <div class="modal-footer">
                          <div class="btn-group btn-group-justified" role="group" aria-label="group button">
                            ...
                            <div class="btn-group" role="group">
                              <button id="saveImage" class="btn btn-default btn-hover-green" data-action="save" name = "insert">Save</button>
                            </div>
                            </form>
                          </div>
                        </div>
