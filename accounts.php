          ...
          <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
              <div class="product-status-wrap">
                ...
                <div class="center"><button data-toggle="modal" data-target="#squarespaceModal" class="btn btn-primary">Add Account</button></div>
                  ...
                  <div class="modal-dialog">
                    <div class="modal-content">
                      <div class="modal-header">
                        ...
                        <h3 class="modal-title" id="lineModalLabel">Add Account</h3>
                      </div>
                      <div class="modal-body">
                        ...
                        <form action="insertaccount.php" method="post">
                          ...
                          <div class="form-group">
                            ...
                            <input type="Name" class="form-control" placeholder="Enter name"  name ="username" required>
                          </div>
                          ...
                          <div class="form-group" "col-lg-3">
                            ...
                            <input type="password" class="form-control"   placeholder="Enter contact number" name ="password" required>
                          </div>

                          <div class="form-group" "col-lg-3">
                            <label for="exampleInputPassword3">Repeat Password</label>
                            <input type="password" class="form-control"  placeholder="Enter contact number" name ="rpassword" required>
                          </div>
                          <!-- <div class="form-group">
                      ...
                      <div class="modal-footer">
                        <div class="btn-group btn-group-justified" role="group" aria-label="group button">
                          ...
                          <div class="btn-group" role="group">
                            <button  id="saveImage" class="btn btn-default btn-hover-green" name ="insert" data-action="save" >Save</button>
                          </div>
                          </form>
                ...
                <div class="modal fade" id="edit-business" tabindex="-1" role="dialog" aria-labelledby="modalLabel" aria-hidden="true">
                  <div class="modal-dialog">
                    <div class="modal-content">
                      <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true"></span><span class="sr-only">Close</span></button>
                        <h3 class="modal-title" id="lineModalLabel">Edit Account</h3>
                      </div>
                      <div class="modal-body">
                        ...
                        <!-- <form>
                          <div class="form-group">
                            ...
                            <input type="Name" class="form-control"  id="exampleEditName1"  placeholder="Enter name">
                          </div>
                          <div class="form-group">
                            <label for="exampleEditAddress1">Address</label>
                            <input type="address" class="form-control"  id="exampleEditAddress1"  placeholder="Enter address">
                          </div>
                          <div class="form-group">
