                      ...
                      <ul class="nav navbar-nav mai-top-nav header-right-menu">
                        ...
                        <li class="nav-item">
                          <a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle">
                            ...
                            <span class="admin-name">Admin Lokal</span>
          ...
          <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
              <div class="product-status-wrap">
                  ...
                  <div class="modal-dialog">
                    <div class="modal-content">
                      <div class="modal-header">
                        ...
                        <h3 class="modal-title" id="lineModalLabel">Add Business</h3>
                      </div>
                      <div class="modal-body">
                        ...
                        <form>
                          ...
                          <div class="form-group">
                            <label for="exampleInputBusiness1">Business</label>
                            <input type="password" class="form-control" id="exampleInputBusiness1" placeholder="Enter business name">
                          </div>
                          <div class="form-group">
                            <label for="exampleInputLocation1">Location</label>
                            <input type="location" class="form-control" id="exampleInputLocation1" placeholder="Enter location">
                          </div>
                          <div class="form-group">
                            <label for="exampleInputNumber1">Contact No.</label>
                            <input type="contact-number" class="form-control" id="exampleInputContact1" placeholder="Enter contact number">
                          </div>
                          <!-- <div class="form-group">
                ...
                <!-- line modal -->
                <div class="modal fade" id="edit-business" tabindex="-1" role="dialog" aria-labelledby="modalLabel" aria-hidden="true">
                  <div class="modal-dialog">
                    <div class="modal-content">
                      <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">×</span><span class="sr-only">Close</span></button>
                        <h3 class="modal-title" id="lineModalLabel">Edit Business</h3>
                      </div>
                      <div class="modal-body">
                        ...
                        <form>
                          <div class="form-group">
                            <label for="exampleEditName1">Name</label>
                            <input type="Name" class="form-control" id="exampleEditEmail1" placeholder="Enter name">
                          </div>
                          <div class="form-group">
                            <label for="exampleEditBusiness1">Business</label>
                            <input type="password" class="form-control" id="exampleEditBusiness1" placeholder="Enter business name">
                          </div>
                          <div class="form-group">
                            <label for="exampleEditLocation1">Location</label>
                            <input type="location" class="form-control" id="exampleEditLocation1" placeholder="Enter location">
                          </div>
                          <div class="form-group">
                            <label for="exampleEditNumber1">Contact No.</label>
                            <input type="contact-number" class="form-control" id="exampleEditContact1" placeholder="Enter contact number">
                          </div>
                          <!-- <div class="form-group">
                            <label for="exampleInputFile">File input</label>
                            <input type="file" id="exampleInputFile">
    ...
    $(document).ready(function(){
        ...
        "columns" : [
          ...
          {"data" : "emailaddress"},
			...
			// 			 "className": "right",
			//
			// 						"defaultContent": '<a href="" class="editor_edit">Edit</a> / <a href="delete.php" name="businessid" class="editor_remove">Delete</a>'
			//
			// }
