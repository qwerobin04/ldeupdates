            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
              <div class="product-status-wrap">
                ...
                <div class="btn-wrapper">
                  <div class="center"><button data-toggle="modal" data-target="#squarespaceModal" class="btn btn-primary">Add Menu</button></div>
                  <!-- line modal -->
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          ...
                          <!-- content goes here -->
                          <form action = "./php/insertmenu.php" method = "post">
                            <div class="form-group">
                              <label for="exampleAddRestaurant1">
                                Restaurant:
                              </label>
                              <select class="field small-field" name = "restaurant" required>
                                <option  value="">Choose Restaurant</option>
                                <option  value="Kick">Kick</option>
                                <option  value="Caramel">Caramel</option>
                                <option  value="Earls">Earls</option>
                              </select>
                            </div>
                            <div class="form-group">
                              <label for="exampleAddMenu1">Menu</label>
                              <input type="menu" name = "menuname" class="form-control" id="exampleAddMenu1" placeholder="Enter new menu" required>
                            </div>
                            <!-- <div class="form-group">
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          ...
                          <form>
                            <div class="form-group">
                              <label for="exampleInputRestaurant1">Restaurant: </label>
                              <select class="field small-field">
                                <option value="">Choose Restaurant</option>
                                <option name ="restaurant" value="">Kick</option>
                                <option name ="restaurant" value="">Caramel</option>
                                <option name ="restaurant" value="">Earls</option>
                              </select>
                            </div>
                            <div class="form-group">
                              <label for="exampleEditMenu1">Menu</label>
                              <input type="editMenu" class="form-control" id="exampleEditMenu1" placeholder="Enter new menu">
                            </div>
                            <!--
                            <button type="submit" class="btn btn-default">Submit</button>
